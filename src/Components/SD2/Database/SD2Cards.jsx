...
import { DivType } from "../js/dict";

export function SD2DeckUnitCard({ x, i }) {
...
export function SD2DeckDeckRow({ x, setUnits }) {
  const [show, setShow] = useState(false);
  return (
    <div className="card">
      <div className="card-header">
        <div className="row">
          ...
          <div className="col-2" onClick={() => setShow(!show)}>
            <img
              src={DivType.find(e => e.k === x.TypeTexture).i}
              className="img-back"
              alt="divType"
            />
          </div>
...
export function SD2UnitUnitRow({ x, i }) {
  try {
...
export function SD2UnitUnitCard({ detail, setDetail }) {
  return detail ? (
...
export function SD2WeaponWeaponRow({ x, i }) {
  try {
    return (
      <React.Fragment>
        <td key={i}>
...
export function SD2WeaponWeaponCard({ detail, setDetail }) {
  return detail ? (
    <div className=" popup-unit">
      <div className="card">
