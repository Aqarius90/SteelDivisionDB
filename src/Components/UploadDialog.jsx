...
class UploadDialog extends Component {
  state = { Replay: null, replayFile: null };
        ...
        <React.Fragment>
          ...
          <div className="row">
            ...
            <div className="col-md-9">
              <input
                className="form-control"
                value={this.state.Replay.Description}
                type="text"
            ...
            <div className="col-md-2">
              <h5>{"Victory: " + this.state.Replay.VictoryCond}</h5>
            </div>
            <div className="col-md-3">
              <h5>{"TimeLimit: " + this.state.Replay.TimeLimit}</h5>
            </div>
            <div className="col-md-3">
            ...
            <div className="col-md-4">
              <h5>{"Map: " + this.state.Replay.Map}</h5>
            </div>
            <div className="col-md-2">
              <h5>{"IncomeRate: " + this.state.Replay.IncomeRate}</h5>
            </div>
            <div className="col-md-2">
              <h5>{"GameType: " + this.state.Replay.GameType}</h5>
            </div>
            <div className="col-md-2">
              <h5>{"GameMode: " + this.state.Replay.GameMode}</h5>
            </div>
